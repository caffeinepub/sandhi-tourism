...
function WhatsAppFloat() {
  ...
  return (
    ...
    >
      ...
      {hovered && (
        <div
          className="font-sans text-xs font-semibold text-white px-3 py-1.5 rounded-lg shadow-lg whitespace-nowrap"
          style={{
  ...
  return (
    <div className="min-h-screen overflow-x-hidden">
      ...
      <main>
        ...
        <div style={{ background: "oklch(0.17 0.04 260)" }}>
          <AboutSection />
          <Footer />
        </div>
      </main>
